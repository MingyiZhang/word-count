...
public class WordCountProcessorApplicationTests {
    ...
    final JsonSerde<KafkaStreamsWordCountApplication.WordCount> countSerde = new JsonSerde<>(
        KafkaStreamsWordCountApplication.WordCount.class);
    ...
    public void testOneWord() {
        ...
        assertThat(output.value()).isEqualToComparingFieldByField(new KafkaStreamsWordCountApplication.WordCount("hello", 1L, new Date(0), new Date(
            KafkaStreamsWordCountApplication.WordCountProcessorApplication.WINDOW_SIZE_MS)));
